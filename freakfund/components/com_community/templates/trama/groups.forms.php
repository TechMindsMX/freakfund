	...
	<?php } ?>
		...
		<ul class="cFormList cFormHorizontal cResetList">
			...
			<li>
				...
				<div class="form-field">
					...
					<label for="approve-private" class="label-checkbox">
						<input type="checkbox" name="approvals" class="input checkbox" id="approve-private" value="1"<?php echo ($group->approvals == COMMUNITY_PRIVATE_GROUP ) ? ' checked="checked"' : '';?> />
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					...
					<label for="photopermission-admin" class="label-checkbox">
						<input type="checkbox" name="photopermission-admin" class="input checkbox" id="photopermission-admin" onclick="checkPhotoPermission()" value="1" <?php echo ($params->get('photopermission') >= 1) ? ' checked="checked"' : '';?> />
					...
					<label for="photopermission-member" class="label-checkbox">
						<input type="checkbox" name="photopermission-member" class="input checkbox" id="photopermission-member" value="1" <?php echo ( $params->get('photopermission') == GROUP_PHOTO_PERMISSION_ALL ) ? ' checked="checked"' : '';?> disabled="disabled" />
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					...
					<label for="videopermission-admin" class="label-checkbox">
						<input type="checkbox" name="videopermission-admin" class="input checkbox" onclick="checkVideoPermission()" id="videopermission-admin" value="1"<?php echo ($params->get('videopermission') >= 1) ? ' checked="checked"' : '';?> />
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					<!-- NEW MEMBER -->
					<label for="newmembernotification-enable" class="label lblradio">
			...
			<li class="has-seperator">
				<div class="form-field">
					<label for="removeactivities" class="label-checkbox">
						<input type="checkbox" name="removeactivities" id="removeactivities" value="1" <?php echo ($params->get('removeactivities', '0') == true ) ? 'checked="checked"' : '';?>  />
					...
					<span class="form-helper"><?php echo JText::_('COM_COMMUNITY_GROUPS_REMOVE_ACTIVITIES_TIPS');?></span>
				</div>
			</li>
			<?php // endif;?>
			...
			<li class="form-action">
				<div class="form-field	">
					...
					<input type="submit" value="<?php echo ($isNew) ? JText::_('COM_COMMUNITY_GROUPS_CREATE_GROUP') : JText::_('COM_COMMUNITY_SAVE_BUTTON');?>" class="cButton cButton-Blue validateSubmit" />
