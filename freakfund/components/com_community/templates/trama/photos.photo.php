...
<div id="cGallery">
			...
			<?php if( ($isOwner || $isAdmin) && ($photo->storage == 'file') ) { ?>
				<li>
					<a title="<?php echo JText::_('COM_COMMUNITY_PHOTOS_ROTATE_LEFT'); ?>" href="javascript:void(0);"  class="photoRotaterActions" onclick="joms.gallery.rotatePhoto('left')">
						<i class="com-icon-rotate-anticlock"></i><span><?php echo JText::_('COM_COMMUNITY_PHOTOS_ROTATE_LEFT'); ?></span>
					</a>
				</li>
				<li>
					<a title="<?php echo JText::_('COM_COMMUNITY_PHOTOS_ROTATE_RIGHT'); ?>" href="javascript:void(0);" class="photoRotaterActions" onclick="joms.gallery.rotatePhoto('right')">
						<i class="com-icon-rotate-clock"></i><span><?php echo JText::_('COM_COMMUNITY_PHOTOS_ROTATE_RIGHT'); ?></span>
					</a>
				</li>
			<?php } ?>
				<li class="cFloat-R">
	...
	<div class="photoTagging">
		<a id="startTagMode" href="javascript: void(0);" onclick="joms.gallery.startTagMode();" class="cButton"><?php echo JText::_('COM_COMMUNITY_TAG_THIS_PHOTO'); ?></a>
		...
		<div class="photoTagInstructions">
			...
			<button class="cButton photoTagInstructionsAction" onclick="joms.gallery.stopTagMode();"><?php echo JText::_('COM_COMMUNITY_PHOTO_DONE_TAGGING'); ?></button>
		</div>
	</div>
	<?php } ?>
