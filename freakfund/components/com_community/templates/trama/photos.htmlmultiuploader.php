...
<div id="photo-uploader" style="overflow:hidden;">
	...
	<div id="upload-footer" style="display:none" style="margin-top: 10px">
		<a class="cButton cButton-Blue add-more" href="javascript: void(0); "><?php echo JText::_('COM_COMMUNITY_PHOTOS_ADD_MORE_PHOTOS'); ?></a><span id="message-between">&nbsp;<?php echo JText::_('COM_COMMUNITY_OR')?>&nbsp;</span>
