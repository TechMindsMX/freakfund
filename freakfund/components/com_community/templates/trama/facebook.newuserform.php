...
<table width="100%">
	<tr>
	    ...
	    <td><input type="text" id="newname" size="30" value="<?php echo $userInfo['name'];?>" onblur="joms.connect.checkRealname(this.value);"/><div id="error-newname" class="small" style="display: none;color: red;"></div></td>
	</tr>
	<tr>
		<td valign="top"><label for="newusername"><?php echo JText::_('COM_COMMUNITY_USERNAME');?></label></td>
		<td><input type="text" id="newusername" class="required" size="30" onblur="joms.connect.checkUsername(this.value)"/><div id="error-newusername" class="small" style="display: none;color: red;"></div></td>
	</tr>
	<tr>
		<td valign="top"><label for="newemail"><?php echo JText::_('COM_COMMUNITY_EMAIL');?></label></td>
		<td><input type="text" id="newemail" value="<?php echo $userInfo['email'];?>" class="required" size="30" onblur="joms.connect.checkEmail(this.value);" /><div id="error-newemail" class="small" style="display: none;color: red;"></div></td>
	</tr>
</table>
