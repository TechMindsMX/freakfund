...
class projectListModelprojectList extends JModelList
{
	public function getDatos() {
		...
		foreach ($queryResp as $key => $value) {
			...
			$value->urlcambio = '<a href="index.php?option=com_aportacionesacapital&task=detail&proyid='.$value->id.'">'.JText::_('COM_APORTACIONESCAPITAL_PROJECTLIST_CHANGESTATUS').'</a>';
		}
