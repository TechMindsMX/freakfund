...
if ( ! class_exists('plgCommunityTwitter'))
{
	class plgCommunityTwitter extends CApplications
	{
		...
		public $timelines = array(
			'public'  => '1/statuses/public_timeline.json',
			'friends' => '1/statuses/friends_timeline.json',
			'home'    => '1/statuses/home_timeline.json',
			'user'    => '1/statuses/user_timeline.json',
			'update'  => '1/statuses/update.json'
		);
		public $users = array(
			'show' => '1/users/show.json'
		);
